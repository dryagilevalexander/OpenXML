...
namespace OpenXML
{
    public class ApplicationContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                new ContractTemplate {Id=1, Name = "Договор подряда", ContractType = 1}
            ...
            new Condition[]
            {
                ...
                new Condition {Id = 2, Name = "Преамбула", Text = "customerName именуемое в дальнейшем \"Заказчик\", в лице директора customerDirectorNameR, действующего на основании Устава, с одной стороны, и executorName, именуемое в дальнейшем \"Подрядчик\", в лице директора executorDirectorNameR, действующего на основании Устава, с другой стороны, baseOfContract заключили настоящий договор о нижеследующем:", TypeOfCondition = 2, ContractTemplateId = 1, RegulationType = 4},
                new Condition {Id = 3, Name = "Предмет договора", TypeOfCondition = 3, ContractTemplateId =  1, RegulationType = 4},
                new Condition {Id = 4, Name = "Права и обязанности сторон", TypeOfCondition = 3, ContractTemplateId = 1, RegulationType = 4},
                new Condition {Id = 5, Name = "Ответственность сторон", TypeOfCondition = 3, ContractTemplateId = 1, RegulationType = 3}
            });
